...
The configuration generator provides an interactive arrow-key menu powered by ``questionary`` with the following options:

+--------------------------+----------------------------------------------------+
| Option Choice            | Description                                        |
+==========================+====================================================+
| Add new printer rule     | Create and insert a new document printing rule     |
+--------------------------+----------------------------------------------------+
| Edit printer rule        | Modify an existing rule section                    |
+--------------------------+----------------------------------------------------+
| Change rule priority     | Reorder rule precedence                            |
+--------------------------+----------------------------------------------------+
| Delete printer rule      | Remove a rule section                              |
+--------------------------+----------------------------------------------------+
| Repair configuration     | Validate and fix invalid/uninstalled printers      |
+--------------------------+----------------------------------------------------+
| Save configuration       | Persist configuration changes to disk              |
+--------------------------+----------------------------------------------------+
| Open help in browser     | Launch official online documentation               |
+--------------------------+----------------------------------------------------+
| Exit / Close             | Exit tool (prompts to save unsaved changes)        |
+--------------------------+----------------------------------------------------+
...
1. Launch the generator (via ``auto-print-config`` or GUI Start Menu shortcut).
2. View the formatted **Rich Table** showing active printing rules and printer status.
3. Use the interactive menu options above to create, reorder, or edit rules.
4. Select ``Save configuration`` or choose ``Save & Exit`` when closing.
